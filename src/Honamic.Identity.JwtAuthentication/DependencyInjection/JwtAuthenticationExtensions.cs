            ...
            where TUser : class
        {
            ...
            builder.AddJwtBearer(cfg =>
            {
                ...
                cfg.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    TokenDecryptionKey = string.IsNullOrEmpty(bearerTokensOptions.EncrtyptKey) ? null : new SymmetricSecurityKey(Encoding.UTF8.GetBytes(bearerTokensOptions.EncrtyptKey)),
